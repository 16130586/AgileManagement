...
INSERT INTO jira.`workflow_item`(id, name, location, color, is_start, is_end, workflow_id) VALUES (1,'Not started','-150 0','green', 1, 0, 1),(2,'In progress','0 0','lightgreen',0,0, 1),(3,'Done','150 0','blue',0,1, 1);
