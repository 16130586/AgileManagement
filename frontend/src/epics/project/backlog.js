...
import { fullFilledBacklogPage, fullFilledRequestDeleteSprint,
...
export const fetchBacklogPage = action$ =>
    action$.pipe(
        ...
        mergeMap(action => {
            ...
            return forkJoin({ backlogItemsRequest: ajax(getBacklogItemsSettings), workingSprintsRequest: ajax(getWorkingSprintsSettings) })
                .pipe(
